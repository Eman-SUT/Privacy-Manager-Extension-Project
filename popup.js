...
// --- 4. Privacy Analysis (NLP) Logic - التعديل المصلح هنا ---
document.getElementById("analyzeBtn").addEventListener("click", async () => {
    ...
    chrome.scripting.executeScript({
        ...
        .then(data => {
            ...
            // التصليح: إذا كان الموقع آمن ولا توجد مخاطر، السكور الافتراضي 100%
